...
def est(startnode, goalnode, visual, show_plot):
    ...
    while not break_outer_loop:
        ...
        while True:
            ...
            if grownode.connectsTo(nextnode) and nextnode.x >= xmin and nextnode.x <= xmax and nextnode.y >= ymin and nextnode.y <= ymax:
...
def main():
    ...
    # Run the EST planner.
    print("Running EST...")
    (path, N) = est(startnode, goalnode, visual, True)
